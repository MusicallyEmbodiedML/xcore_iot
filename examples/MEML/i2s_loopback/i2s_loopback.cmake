...
# Tile Targets
#**********************
add_executable(meml_i2s_loopback)
target_sources(meml_i2s_loopback PUBLIC ${APP_SOURCES})
...
mic_array_vanilla_add( meml_i2s_loopback
    24576000  3072000   2           256 )

#**********************
# Create run and debug targets
#**********************
create_run_target(meml_i2s_loopback)
create_debug_target(meml_i2s_loopback)
create_flash_app_target(meml_i2s_loopback)
create_install_target(meml_i2s_loopback)
